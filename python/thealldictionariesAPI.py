...
class DB():
    ...
    def addUser(self, fullName, nickName, userID, password, email, phoneNumber):
        ...
        self.cursor.execute(query1, (userID, isAdmin, )) 
        self.cursor.execute(query2, (fullName, nickName, userID, password, email, phoneNumber, isPremium, )) 
    ...
    def addAdmin(self, fullName, nickName, userID, password, email, phoneNumber, jobTitle):
        ...
        self.cursor.execute(query1, (userID, isAdmin, )) 
        self.cursor.execute(query2, (fullName, nickName, userID, password, email, phoneNumber, jobTitle, )) 
        self.conn.commit()
    ...
    def deleteUser(self, userID):
        ...
        query7 = 'DELETE FROM HasSentenceRanking WHERE userID = (%s)'
    ...
    def deleteAdmin(self, userID):
        ...
        query3 = """DELETE FROM HasTextRanking WHERE challengeTitle in 
                    (SELECT title FROM GenerateTextChallenge WHERE creatorID = (%s)"""
        query4 = """DELETE FROM TextChallenge WHERE title in 
                    (SELECT title FROM GenerateTextChallenge WHERE creatorID = (%s))"""
        self.cursor.execute(query1, (userID, ))
        self.cursor.execute(query2, (userID, ))
        self.cursor.execute(query3, (userID, ))
