...
class DB():
    ...
    def updateUserEmail(self, userID, newEmail):
        self.query = "UPDATE UserAccount SET email = '{newEmail}' WHERE userID = '{userID}'"
        self.executeQueryAndCommit()
    
    def updateAdminEmail(self, userID, newEmail):
        self.query = "UPDATE AdminAccount SET email = '{newEmail}' WHERE userID = '{userID}'"
        self.executeQueryAndCommit()
    
    def updateUserPhoneNumber(self, userID, newPhoneNumber):
        self.query = "UPDATE UserAccount SET phoneNumber = '{newPhoneNumber}' WHERE userID = '{userID}'"
        self.executeQueryAndCommit()
    
    def updateAdminPhoneNumber(self, userID, newPhoneNumber):
        self.query = "UPDATE AdminAccount SET phoneNumber = '{newPhoneNumber}' WHERE userID = '{userID}'"
        self.executeQueryAndCommit()
    ...
    def sendMessage(self, roomName, senderID, receiverID, chatMessage, sendDate):
        self.query= f"INSERT INTO ChatRoom VALUES ('{roomName}', '{senderID}', '{receiverID}', '{chatMessage}', '{sendDate}')"
        self.executeQueryAndCommit()
