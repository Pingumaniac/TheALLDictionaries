$(document).ready(function () {
    ...
    if (WORD_INPUT == "") {
        var synonymHTML = "<li>No synonym found at synonym.com.</li>";
        $("#synonymList").append(synonymHTML);
        var antonymHTML = "<li>No antonym found at synonym.com.</li>";
        $("#antonymList").append(antonymHTML);
    } 
    else {
        synonymPolling();
    }
